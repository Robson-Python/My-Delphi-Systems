object frmConsultaEntradaAnimais: TfrmConsultaEntradaAnimais
  Left = 189
  Top = 112
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Sys Point - Consulta de Entrada de Animais'
  ClientHeight = 598
  ClientWidth = 952
  Color = clBtnFace
