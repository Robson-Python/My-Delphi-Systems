...
begin
    ...
    With dmCarroComando.ADOQuery1 do begin
       ...
       ExecSQL;
       Application.MessageBox('Usuário e Senha cadastrados com sucesso!','Omega - Sucesso',MB_OK+MB_ICONINFORMATION);
    ...
    With dmCarroComando.ADOQuery1 do begin
       ...
       If sSenha = edtSenha.Text then begin
         If FieldByName('nivel').AsString = 'Alto' then begin
          ...
          Application.MessageBox('Usuario e Senha incorretos!','Omega - Informação',MB_OK+MB_ICONERROR);
       end;
    end;
end;
...
begin
    ...
    With dmCarroComando.ADOQuery1 do begin
       ...
       ExecSQL;
       Application.MessageBox('Usuário e Senha atualizados com sucesso!','Omega - Sucesso',MB_OK+MB_ICONINFORMATION);
...
begin
    If Application.MessageBox('Tem certeza que deseja deletar esse Usuário?','Omega - Confirmação de Exclusão',MB_YESNO+MB_ICONQUESTION) = ID_YES then begin
       With dmCarroComando.ADOQuery1 do begin
          Active := False;
          SQL.Clear;
          SQL.Add('Delete from senha where user_name = '+QuotedStr(cbxUsuario.Text)+'');
          ExecSQL;
          Application.MessageBox('Usuário e Senha Deletados com sucesso!','Omega - Sucesso',MB_OK+MB_ICONINFORMATION);
          btnLimparClick(Sender);
       end;
    end;
end;
