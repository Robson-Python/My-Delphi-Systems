object frmAbastFinal: TfrmAbastFinal
  Left = 192
  Top = 114
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 
    'Carro Comando - Gerenciamento de Combust'#237'veis [Abastecimentos Fi' +
    'nalizados]'
  ClientHeight = 448
  ClientWidth = 632
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object RadioButton1: TRadioButton
      ...
      Width = 185
      Height = 17
      Caption = 'Todos os abastecimentos'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
  ...
  object Panel4: TPanel
    ...
    Caption = 'Abastecimentos realizados pelo ve'#237'culo'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWhite
    Font.Height = -13
    Font.Name = 'Arial'
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        Title.Caption = 'Marca do Combust'#237'vel'
        Width = 183
        Visible = True
      end
      item
