...
uses DateUtils, DB, Principal_frm, Carro_Comando_dm, Agenda_qrp;
...
begin
    If edtEvento.Text <> '' then begin
       ...
       Application.MessageBox('O campo Local não pode estar vazio!','MyCar - Atenção',MB_OK+MB_ICONWARNING);
    end;
end;
...
begin
    If edtCod.Text <> '' then begin
       ...
       Application.MessageBox('O campo código não pode ser vazio! Selecione um registro para atualizar dados.','MyCar - Atenção',MB_OK+MB_ICONWARNING);
    end;
end;
