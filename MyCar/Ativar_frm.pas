       ...
       If dData = dDataValid  then begin
          ...
          With dmCarroComando.ADOQuery1 do begin
             ...
             If Trim(nProtocolo) = Trim(edtLicenca.Text) then begin
                ...
                Application.MessageBox('Sua Licença foi renovada para mais 30 dias. Para efetivar a Licença feche o Programa e execute-o novamente','Carro Comando - Sucesso',MB_OK+MB_ICONINFORMATION);
                ShowMessage('O Nº do protocolo de ativação é: '+sProtocolo+'');
             end
             else begin
                Application.MessageBox('Licença Inválida! Entre em contato com o Programador para obter uma licença válida.','Carro Comando - Erro Fatal',MB_OK+MB_ICONERROR);
             end;
          end;
       end
       else begin
          Application.MessageBox('Você possui uma licença válida.','Carro Comando - Aviso',MB_OK+MB_ICONINFORMATION);
       end;
    end
    else begin
       DateSeparator := '/';
