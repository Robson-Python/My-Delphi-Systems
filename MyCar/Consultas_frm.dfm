object frmConsultas: TfrmConsultas
  ...
  Caption = 'Carro Comando - Gerador de Consultas'
  ClientHeight = 486
  ClientWidth = 752
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      Width = 497
      Height = 113
      Caption = 'Digite a consulta que deseja fazer:'
      ...
      object cbxConsulta: TComboBox
        ...
        TabOrder = 0
        Items.Strings = (
          'CONSUMO M'#201'DIO GERAL DE COMBUST'#205'VEL'
          'CONSUMO TOTAL (LITROS) DE COMBUST'#205'VEL'
          'CONSUMO DE COMB'#218'STIVEL POR MOTORISTA'
          'CONTAS '#192' PAGAR VENCIDAS'
          'KILOMETRAGEM PERCORRIDA POR MOTORISTA'
          'PESSOAS QUE MAIS DIRIGIRAM O VE'#205'CULO'
          'RELA'#199#195'O DAS PE'#199'AS TROCADAS NO VE'#205'CULO'
          'VALOR TOTAL DE GASTOS COM PE'#199'AS E SERVI'#199'OS'
          'VALORES GASTOS POR PE'#199'AS E SERVI'#199'OS'
          'VALORES GASTOS COM COMBUST'#205'VEL'
          'VALORES GASTOS POR ABASTECIMENTO')
      end
  ...
  object Panel4: TPanel
    ...
    Caption = 'Resultado das Consutas'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWhite
    Font.Height = -13
    Font.Name = 'Arial'
