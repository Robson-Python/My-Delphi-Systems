object frmPecFin: TfrmPecFin
  Left = 191
  Top = 113
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 
    'Carro Comando - Gerenciamento de Pe'#231'as e Servi'#231'os [Pe'#231'as e Servi' +
    #231'os Funcionando e Trocadas]'
  ClientHeight = 584
  ClientWidth = 816
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        Title.Caption = 'Marca Pe'#231'a/Nome Servi'#231'o'
        Width = 235
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Modelo Pe'#231'a/Servi'#231'o'
        Width = 237
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        Title.Caption = 'Garantia (Meses/Km)'
        Width = 138
        Visible = True
      end
      item
