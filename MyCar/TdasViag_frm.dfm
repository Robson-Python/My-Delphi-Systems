object frmTdasViag: TfrmTdasViag
  Left = 192
  Top = 114
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 
    'Carro Comando - Gerenciamento de Viagens e Percursos [Consulta d' +
    'e todas as Viagens]'
  ClientHeight = 479
  ClientWidth = 632
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        Title.Caption = 'Hora da Sa'#237'da'
        Width = 100
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Hod'#244'metro Inicial'
        Width = 122
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Hod'#244'metro Final'
        Width = 114
        Visible = True
      end
      item
        Color = 11205119
        Expanded = False
        Title.Caption = 'Km Percorrido'
        Width = 102
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Destino ou Volta'
        Width = 239
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Data da Chegada'
        Width = 117
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Hora da Chegada'
        Width = 118
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Dura'#231#227'o da Viagem'
        Width = 134
        Visible = True
      end
      item
  ...
  object Panel4: TPanel
    ...
    Caption = 'Viagens e Percusos realizados por esse Ve'#237'culo'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWhite
    Font.Height = -13
    Font.Name = 'Arial'
