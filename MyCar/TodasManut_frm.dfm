object frmTodasManut: TfrmTodasManut
  Left = 192
  Top = 114
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 
    'Carro Comando - Gerenciamento de Manuten'#231#245'es [Manuten'#231#245'es Vencid' +
    'as]'
  ClientHeight = 446
  ClientWidth = 633
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        Title.Caption = 'Nome do Revendedor'
        Width = 209
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Data do Servi'#231'o'
        Width = 108
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        Title.Caption = 'Servi'#231'o Km'
        Width = 83
        Visible = True
      end
      item
        Expanded = False
        Title.Caption = 'Vencimento Km'
        Width = 109
        Visible = True
      end
      item
  ...
  object Panel4: TPanel
    ...
    Caption = 'Manuten'#231#245'es realizadas no Ve'#237'culo'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWhite
    Font.Height = -13
    Font.Name = 'Arial'
  ...
  object Panel1: TPanel
    ...
    object RadioButton1: TRadioButton
      ...
      Width = 185
      Height = 17
      Caption = 'Todos as manuten'#231#245'es'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
