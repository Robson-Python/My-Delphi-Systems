...
begin
    ...
    With dmEnterprise.zqEnterprise do begin
       ...
       ExecSQL;
       Application.MessageBox('Usuário e Senha cadastrados com sucesso!','MyShop - Sucesso',MB_OK+MB_ICONINFORMATION);
    ...
    With dmEnterprise.zqEnterprise do begin
       ...
       If sSenha = edtSenha.Text then begin
         If FieldByName('nivel').AsString = 'Administrador' then begin
          ...
          Application.MessageBox('Usuario e Senha incorretos!','MyShop - Informação',MB_OK+MB_ICONERROR);
       end;
    end;
end;
...
begin
    ...
    With dmEnterprise.zqEnterprise do begin
       ...
       ExecSQL;
       Application.MessageBox('Usuário e Senha atualizados com sucesso!','MyShop - Sucesso',MB_OK+MB_ICONINFORMATION);
...
begin
    If Application.MessageBox('Tem certeza que deseja deletar esse Usuário?','MyShop - Confirmação de Exclusão',MB_YESNO+MB_ICONQUESTION) = ID_YES then begin
       With dmEnterprise.zqEnterprise do begin
          Active := False;
          SQL.Clear;
          SQL.Add('Delete from senha where user_name = '+QuotedStr(cbxUsuario.Text)+'');
          ExecSQL;
          Application.MessageBox('Usuário e Senha Deletados com sucesso!','MyShop - Sucesso',MB_OK+MB_ICONINFORMATION);
          btnLimparClick(Sender);
       end;
    end;
end;
