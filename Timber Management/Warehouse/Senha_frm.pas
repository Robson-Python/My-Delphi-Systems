...
begin
    ...
    If sSenha1 <> sSenha2 then begin
       Application.MessageBox('Senha Inválida!','Sistema Almoxarifado',MB_OK+MB_ICONERROR);
        edtSenha.SetFocus;
    end
    else begin
       Close;
       Application.MessageBox('Bem-vindo ao Sistema Sistema Almoxarifado!','Sistema Almoxarifado',MB_OK+MB_ICONINFORMATION);
