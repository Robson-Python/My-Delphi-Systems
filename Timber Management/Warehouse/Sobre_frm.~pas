...
begin
    ...
    Except
      Application.MessageBox('Verifique se seu computador possui o Skype instalado!','Sistema Almoxarifado - Aviso',MB_OK+MB_ICONINFORMATION);
    end;
end;
...
begin
    ...
    Except
      Application.MessageBox('Verifique se seu computador possui o Windows Live Messenger instalado!','Sistema Almoxarifado - Aviso',MB_OK+MB_ICONINFORMATION);
    end;
end;
...
begin
    If edtRegistro.Text <> '' then begin
       ...
       Application.MessageBox('Os Campos não podem ser vazios! Preencha os campos e tente novamente.','Sistema Almoxarifado - Atenção',MB_OK+MB_ICONERROR);
