...
begin
    ...
    With dmVendas.ADOQuery1 do begin
       ...
       ExecSQL;
       Application.MessageBox('Usuário e Senha cadastrados com sucesso!','Sistema Almoxarifado - Sucesso',MB_OK+MB_ICONINFORMATION);
       btnLimparClick(Sender);
    end;
end;

procedure TfrmUsuario.btnSelecionarClick(Sender: TObject);
var nNivel, sSenha : String;
begin
    With dmVendas.ADOQuery1 do begin
       Active := False;
       SQL.Clear;
       ...
       If sSenha = edtSenha.Text then begin
         If FieldByName('nivel').AsString = 'Alto' then begin
          ...
          Application.MessageBox('Usuario e Senha incorretos!','Sistema Almoxarifado - Informação',MB_OK+MB_ICONERROR);
       end;
    end;
end;
...
begin
    ...
    With dmVendas.ADOQuery1 do begin
       ...
       ExecSQL;
       Application.MessageBox('Usuário e Senha atualizados com sucesso!','Sistema Almoxarifado - Sucesso',MB_OK+MB_ICONINFORMATION);
...
begin
    If Application.MessageBox('Tem certeza que deseja deletar esse Usuário?','Sistema Almoxarifado - Confirmação de Exclusão',MB_YESNO+MB_ICONQUESTION) = ID_YES then begin
       With dmVendas.ADOQuery1 do begin
          Active := False;
          SQL.Clear;
          SQL.Add('Delete from senha where user_name = '+QuotedStr(cbxUsuario.Text)+'');
          ExecSQL;
          Application.MessageBox('Usuário e Senha Deletados com sucesso!','Sistema Almoxarifado - Sucesso',MB_OK+MB_ICONINFORMATION);
          btnLimparClick(Sender);
       end;
    end;
end;
