    ...
    If RadioButton1.Checked = True then begin
       If edtRomaneio.Text = '0' then begin
          ...
          With ADOQuery1 do begin
             Active := false;
             SQL.Clear;
             SQL.Add('SELECT P.romaneio ''roman'', count(*) ''total'', sum(((diametro1+diametro2)/2)*((diametro1+diametro2)/2)*comprimento*0.7854) ''vol'', sum(((diametro1+diametro2)/2)*((diametro1+diametro2)/2)*comprimento*0.7854)* P.custo ''preço'' '+
