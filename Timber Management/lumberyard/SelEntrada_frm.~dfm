object frmSelEntrada: TfrmSelEntrada
  Left = 191
  Top = 113
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Sistema Almoxarifado - Consulta de Entrada'
  ClientHeight = 513
  ClientWidth = 816
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object rdbEntrada: TRadioButton
        ...
        Width = 201
        Height = 17
        Caption = 'Todas as Entradas/Compras'
        TabOrder = 1
      ...
      object rdbNFiscal: TRadioButton
        Left = 24
        Top = 56
        Width = 185
        Height = 17
        Caption = 'N'#186' Nota Fiscal/Romaneio'
        TabOrder = 3
        OnClick = rdbNFiscalClick
      end
      object edtNfiscal: TEdit
        Left = 208
        Top = 48
        Width = 89
        Height = 24
  ...
  object DBGrid1: TDBGrid
    ...
    Height = 305
    Hint = 
      'Selecione um C'#243'digo e d'#234' um duplo clique para mostrar os itens d' +
