object frmSelSaida: TfrmSelSaida
  Left = 191
  Top = 113
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Sistema Almoxarifado - Consulta de Sa'#237'da'
  ClientHeight = 505
  ClientWidth = 785
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object rdbSaida: TRadioButton
        ...
        Width = 201
        Height = 17
        Caption = 'Todas as Sa'#237'da/Vendas'
        TabOrder = 1
      end
      object edtCod: TEdit
        Left = 200
