...
begin
    If edtUser.Text <> '' then begin
       ...
       Application.MessageBox('Os Campos não podem ser vazios! Preencha os campos e tente novamente.','MyBook - Atenção',MB_OK+MB_ICONERROR);
       edtUser.SetFocus;
    end;
end;
...
begin
    If edtUser.Text <> '' then begin
       If OpenPictureDialog1.Execute then begin
          ...
          Application.MessageBox('Os campos não podem ser vazios! Selecione um registro para carregar a foto...','MyBook - Atenção',MB_OK+MB_ICONERROR);
    end;
...
begin
    If edtUser.Text <> '' then begin
       ...
       Application.MessageBox('Os campos não podem ser vazios! Selecione um registro para remover a foto...','MyBook - Atenção',MB_OK+MB_ICONERROR);
    end;
end;
